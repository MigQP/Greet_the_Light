...
public class Baj_loop_H_Anim : MonoBehaviour
{
    #region Enums
    ...
    public void Start()
    {
        ...
        Koreographer.Instance.RegisterForEvents("baj_loop_H_Anim", OnMusicalShoot);
